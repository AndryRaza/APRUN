...
$req = $bdd2->prepare("SELECT COUNT(*) FROM `utilisateur_role` where id_role = '2' ");
$req->execute();
...
<nav aria-label="Page navigation example w-100" id="pagination">
    <ul class="pagination">
        <?php
        if ($page > 1) {
            echo '<li class="page-item"><a class="page-link" href="../pages/admin_liste_formateurs.php?page=' . ($page - 1) . '"> Précédent </a> </li>';
        }
        // Afficher les numéros des pages
        for ($page = 1; $page <= $number_of_pages; $page++) {
            echo '<li class="page-item"><a class="page-link" href="../pages/admin_liste_formateurs.php?page=' . $page . '">' . $page . '</a> </li>';
        }

        if ($_GET['page'] < $number_of_pages) {
            echo '<li class="page-item"><a class="page-link" href="../pages/admin_liste_formateurs.php?page=' . ($_GET['page'] + 1) . '"> Suivant </a> </li>';
        }
