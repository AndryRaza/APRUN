    ...
    <div class="row row-cols-md-3 row-cols-1">
        <div class="col d-flex align-items-center flex-column py-5">
            <a href="admin_accueil_creation.php">
                <img src="../ressources/icones/icone7.png" width="200px" height="200px">
            </a>
            <p>Création compte & promos</p>
        </div>
        <div class="col d-flex align-items-center flex-column py-5">
            <a href="admin_gestion_compte_liste.php">
                <img src="../ressources/icones/icone6.png" width="200px" height="200px">
            </a>
        ...
        <div class="col d-flex align-items-center flex-column py-5">
            <a href="apprenant_edt.php">
                <img src="../ressources/icones/icone4.png" width="200px" height="200px">
            </a>
        ...
        <div class="col d-flex align-items-center flex-column py-5">
            <a href="apprenant_edt.php">
                <img src="../ressources/icones/logout.png" width="200px" height="200px">
            </a>
            <p>Déconnexion</p>
        </div>
